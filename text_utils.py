...
GENERIC_STOP: Set[str] = {
    ...
    "уже", "был", "была", "были", "было", "есть", "нет", "да", "об", "а",
    "но", "или", "если", "так", "его", "её", "их",
}

# Speaker nouns: noise in recall lines, which are all "User: … Assistant: …".
SPEAKER_STOP: Set[str] = GENERIC_STOP | {
    "user", "user's", "assistant",
    "пользователь", "пользователя", "пользователю", "ассистент",
}
...
PRONOUN_STOP: Set[str] = GENERIC_STOP | {
    ...
    "their", "his", "her",
    "мне", "меня", "мой", "моя", "мои", "ты", "вы", "он", "она", "они",
}
